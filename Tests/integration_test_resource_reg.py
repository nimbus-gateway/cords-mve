...
#         # Optional: Add a delay or a health check to ensure services are ready
#         # e.g., time.sleep(10) or perform a ping check on services

#         yield  # This allows pytest to run the tests after this setup

#     finally:
#         # Step 2: Tear down the Docker Compose services
#         print("Stopping Docker Compose services...")
#         subprocess.run(
#             ["docker-compose", "-f", DOCKER_COMPOSE_FILE, "-p", DOCKER_COMPOSE_PROJECT_NAME, "down"],
#             check=True
#         )
...
def test_create_resource_description():
    # 1. Trigger a request to Service A
    username = "tharindu.prf@gmail.com"
    password = "password123"
