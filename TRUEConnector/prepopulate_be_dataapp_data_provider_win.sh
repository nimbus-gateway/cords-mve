...
docker run --rm -v "C:\Users\david.jovanovic\Documents\work11.20\true-connector-mvds\TRUEConnector\be-dataapp_data_provider:/source_data" -v "be_dataapp_provider_data:/target_data" alpine sh -c "cp -r /source_data/* /target_data/datalake/"
